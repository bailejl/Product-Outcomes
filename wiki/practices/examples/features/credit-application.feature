...
# This is a broken scenario to demonstrate the logging and screenshot
# logging abilities.  To see the logs, open the file below and navigate
...
# Good example of testing system errors.  This may require running the
# system under test supported by mocks.  Thus, it is easy to inject
# This type of failure.
Scenario: Error due to form processing unavailable
