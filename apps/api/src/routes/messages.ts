...
import { AuthService, AuthenticatedRequest } from '@product-outcomes/auth'
...
// POST /api/messages - Create new message (protected route)
router.post(
  '/',
...
// PUT /api/messages/:id - Update message (protected route)
router.put(
  '/:id',
  authService.middleware.authenticate,
  async (req: AuthenticatedRequest, res: Response) => {
...
// DELETE /api/messages/:id - Delete message (protected route)
router.delete(
  '/:id',
  authService.middleware.authenticate,
  async (req: AuthenticatedRequest, res: Response) => {
